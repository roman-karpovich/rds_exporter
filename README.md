...
[![Release](https://img.shields.io/github/release/percona/rds_exporter.svg?style=flat)](https://github.com/roman-karpovich/rds_exporter/releases/latest)
[![Build Status](https://travis-ci.com/percona/rds_exporter.svg?branch=master)](https://travis-ci.com/percona/rds_exporter)
[![Go Report Card](https://goreportcard.com/badge/github.com/roman-karpovich/rds_exporter)](https://goreportcard.com/report/github.com/roman-karpovich/rds_exporter)
...
You can see a list of basic monitoring metrics [there](https://github.com/roman-karpovich/rds_exporter/blob/master/basic/testdata/all.txt)
and a list of enhanced monitoring metrics in text files [there](https://github.com/roman-karpovich/rds_exporter/tree/master/enhanced/testdata).
